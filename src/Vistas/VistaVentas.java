...
public class VistaVentas extends javax.swing.JFrame {
    ...
    private List<E_Ventas> listadodata;
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(7, 7, 7)))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtIdEmpleado, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
                ...
                .addGap(26, 26, 26)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtIdProducto, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
        ...
        jLabel3.setText("MOVIMIENTO VENTAS");
    ...
    public void TablaDatos() {
        ...
        datos.addColumn("ID");
        datos.addColumn("Fecha Venta");
        datos.addColumn("Id Empleado"); // Agrega los encabezados correctos aquí
        datos.addColumn("Id Producto");
        datos.addColumn("Cantidad");
        datos.addColumn("Preico Unitario");
    ...
    private void listarData() {
        ...
        listadodata = c.ObtengoVenta();
        for (E_Ventas e : listadodata) {
            Object[] dataUsuario = {e.getId(), e.getFechaVenta(), e.getIdEmpleado(), e.getIdProducto(), e.getCantidadVendida(), e.getPrecioUnitario(), e.getTotalVenta()};
            datos.addRow(dataUsuario);
        }
    }

    private void InsertoDatos() {
        String fVenta = txtFechaVenta.getText();
        ...
        Consultas c = new Consultas();
        c.InsertoVenta(fVenta, idEmpleado, idProducto, cantidad, precio, total);
    ...
    private void mostrarDatosEnCampos(int filaSeleccionada) {
        if (filaSeleccionada < listadodata.size()) {
            E_Ventas usuario = listadodata.get(filaSeleccionada);
            txtFechaVenta.setText(usuario.getFechaVenta());
            txtIdEmpleado.setText(usuario.getIdEmpleado());
            txtIdProducto.setText(usuario.getIdProducto());
            txtCantidad.setText(usuario.getCantidadVendida());
            txtPrecio.setText(usuario.getPrecioUnitario());
            txtTotal.setText(usuario.getTotalVenta());
    ...
    private void modificarUsuario() {
        ...
        String total = txtTotal.getText();
        Consultas c = new Consultas();
        c.ActualizarVenta(idEmpleado, idProducto, cantidad, precio, total, fVenta);
    ...
    private void eliminoUsuario() {
        ...
        if (filaSeleccionada != -1) {
            ...
            if (confirmacion == JOptionPane.YES_OPTION) {
                ...
                if (c.EliminarVenta(usuario.getId())) {
