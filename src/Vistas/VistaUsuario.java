...
public class VistaUsuario extends javax.swing.JFrame {
    ...
    private List<E_Usuario> listadodata;
    ...
    public void TablaDatos() {
        ...
        datos.addColumn("Apellido"); // Agrega los encabezados correctos aquí
    ...
    private void listarData() {
        ...
        listadodata = c.ObtengoUsuario();
        for (E_Usuario e : listadodata) {
            Object[] dataUsuario = {e.getId(), e.getNombre(), e.getApellido(), e.getEdad(), e.getDireccion(), e.getTelefono()};
    ...
    private void InsertoDatos() {
        ...
        Consultas c = new Consultas();
        c.InsertoUsuario(nombre, apellido, edad, direccion, telefono);
    ...
    private void mostrarDatosEnCampos(int filaSeleccionada) {
        if (filaSeleccionada < listadodata.size()) {
            E_Usuario usuario = listadodata.get(filaSeleccionada);
    ...
    private void modificarUsuario() {
        ...
        String telefono = txtTelefono.getText();
        Consultas c = new Consultas();
        c.ActualizarUsuario(nombre, apellido, edad, direccion, telefono);
    ...
    private void eliminoUsuario() {
        ...
        if (filaSeleccionada != -1) {
            ...
            if (confirmacion == JOptionPane.YES_OPTION) {
                ...
                if (c.EliminarUsuario(usuario.getId())) {
